...
def get_resolution_suffix() -> str:
    ...
    log(f"현재 해상도: {width}x{height} -> {resolution} 템플릿 세트 사용")
    return resolution


def get_template_paths():
    resolution = get_resolution_suffix()
    return [
...
def get_balloon_paths():
    resolution = get_resolution_suffix()
    return f"assets/balloon_icon_{resolution}.png", f"assets/form_start_button_{resolution}.png"
